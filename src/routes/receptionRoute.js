...
receptionRoute.post('/receptions', authMiddleware, roleAdminMiddleware, addRequestReceptionValidator, ReceptionController.createReception)
receptionRoute.delete('/receptions/:id', authMiddleware, roleAdminMiddleware, deleteReceptionValidatore, ReceptionController.deleteReception)
